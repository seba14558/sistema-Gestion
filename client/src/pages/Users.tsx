    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center px-4 py-2 bg-accent-purple hover:bg-accent-purple/80 text-white rounded-lg transition-colors"
        >
      ...
      {showForm && (
        <div className="p-6 bg-dark-800/50 backdrop-blur-xl border border-white/10 rounded-xl">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10">
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">Fecha de Creación</th>
                ...
                <tr key={user.id} className="border-b border-white/5 hover:bg-white/5">
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-accent-purple to-accent-blue flex items-center justify-center text-white font-bold mr-3">
