    ...
    <div className="page-container p-6 animate-fade-in text-text-primary">
      ...
      <div className="glass-card p-6 rounded-xl border border-white/10 shadow-xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-6 items-end">
          <div><label className="block text-sm text-text-secondary font-medium mb-1">Desde</label><input type="date" className="input-field w-full p-2.5 bg-dark-800 border border-white/10 rounded-xl text-text-primary text-sm" value={filters.fechaDesde} onChange={e => setFilters({...filters, fechaDesde: e.target.value})} /></div>
          <div><label className="block text-sm text-text-secondary font-medium mb-1">Hasta</label><input type="date" className="input-field w-full p-2.5 bg-dark-800 border border-white/10 rounded-xl text-text-primary text-sm" value={filters.fechaHasta} onChange={e => setFilters({...filters, fechaHasta: e.target.value})} /></div>
